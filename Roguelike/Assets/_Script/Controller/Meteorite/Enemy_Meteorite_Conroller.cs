...
public class Enemy_Meteorite_Conroller : Meteorite_Conroller
{
    ...
    {
        base.Awake();
        damage = PrefabManager.instance.enemy_Orb_Controller.damage * 0.8f;
        moveSpeed = PrefabManager.instance.enemy_Orb_Controller.moveSpeed * 0.8f;
        transform.localScale = PrefabManager.instance.enemy_Orb_Controller.transform.localScale * 3;
    }
    ...
    public void AttackTakeDamage()
    {
        ...
        foreach (Collider2D hit in colliders)
        {
            ...
            {
                hit.GetComponent<PlayerStats>()?.TakeDamage(damage * (1 + DataManager.instance.caster_Skill_Data.skill_2_extraAddExplodeDamage));
