...
public class EnemySlimePatrolState : EnemySlimeGroundState
{
    private Vector3 target;

    public EnemySlimePatrolState(EnemyBase enemy, EnemyStateMachine stateMachine, string animboolName, Enemy_Slime enemy_Slime) : base(enemy, stateMachine, animboolName, enemy_Slime)
    {
    }
