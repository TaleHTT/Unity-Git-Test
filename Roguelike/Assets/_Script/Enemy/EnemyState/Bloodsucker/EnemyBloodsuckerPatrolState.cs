...
public class EnemyBloodsuckerPatrolState : EnemyBloodsuckerGroundState
{
    private Vector3 target;

    public EnemyBloodsuckerPatrolState(EnemyBase enemy, EnemyStateMachine stateMachine, string animboolName, Enemy_Bloodsucker enemy_Bloodsucker) : base(enemy, stateMachine, animboolName, enemy_Bloodsucker)
    {
    }
