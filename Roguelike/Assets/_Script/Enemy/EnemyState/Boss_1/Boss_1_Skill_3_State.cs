...
public class Boss_1_Skill_3_State : BossState
{
    private Boss_1 boss_1;
    private Transform current;
    public Boss_1_Skill_3_State(BossBase boss, EnemyStateMachine stateMachine, string animboolName, Boss_1 boss_1) : base(boss, stateMachine, animboolName)
    {
        this.boss_1 = boss_1;
    }
