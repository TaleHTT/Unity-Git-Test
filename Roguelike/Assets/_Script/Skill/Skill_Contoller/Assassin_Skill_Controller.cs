...
public class Assassin_Skill_Controller : Skill_Controller
{
    ...
    private GameObject CreateDaggerFunc()
    {
        ...
        objects.GetComponent<Dagger_Controller>().assassin_Skill_Controller = this;
