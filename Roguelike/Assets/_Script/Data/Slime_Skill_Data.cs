...
public class Slime_Skill_Data : ScriptableObject
{
    ...
    [Range(0, 10)] public float skill_X_ExtraAddArmor;
    [Range(0, 10)] public float skill_2_ExtraAddArmor;
    [Range(0, 10)] public float skill_1_ExtraAddHp;
    [Range(0, 10)] public float skill_2_ExtraAddHp;
    [Range(0, 10)] public float skill_X_ExtraAddHp;
