...
{
    [Range(0, 1)] public float enemy_ExtraAddAttackSpeed;
    [Range(0, 1)] public float num_ExtraAddAttackSpeed;
    [Range(0, 1)] public float extraAddDamage;
    [Range(0, 1)] public float depleteHp;
    [Range(0, 1)] public float recoverHp;
